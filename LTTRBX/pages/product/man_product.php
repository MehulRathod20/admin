								...
								<div class="filter">
										<div class="checkbox" id="check">
											<ul>		
												...
												<label for="" class="fs-6">Man</label></li>
												<li><input type="radio"  id="gender" name="gender">
												<label for="" class="fs-6">Female</label></li>
												<li><input type="radio"  id="gender" name="gender">
												<label for="" class="fs-6">Kinds</label></li>
											</ul>
										</div>
									</div>
									<div class="filter">
									<h5>Categories</h5>
										<div class="checkbox" id="check">
											<ul>		
												...
												<label for="" class="fs-6">shirt</label></li>
												<li><input type="checkbox"  id="check">
												<label for="" class="fs-6">shirt</label></li>
												<li><input type="checkbox"  id="check">
												<label for="" class="fs-6">shirt</label></li>
									...
									<h5>Brand</h5>
										<div class="checkbox" id="check">
											<ul>		
												<li><input type="checkbox" id="check">
												<label for="" class="fs-6">Brand 1</label></li>
												<li><input type="checkbox"  id="check">
												<label for="" class="fs-6">Brand 2</label></li>
												<li><input type="checkbox"  id="check">
												<label for="" class="fs-6">Brand 3</label></li>
											</ul>
										</div>
									</div>
									<div class="filter">
									<h5>Price</h5>
										<div class="checkbox" id="check">
											<ul>		
												<li><input type="checkbox" id="check">
												<label for="" class="fs-6"> Rs. 79 to Rs. 10935</label></li>
												<li><input type="checkbox"  id="check">
												<label for="" class="fs-6"> Rs. 79 to Rs. 10935</label></li>
												<li><input type="checkbox"  id="check">
												<label for="" class="fs-6"> Rs. 79 to Rs. 10935</label></li>
